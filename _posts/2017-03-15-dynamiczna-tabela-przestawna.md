...
![monty python](/assets/2017-03-15-dynamiczna-tabela-przestawna/monty-python.jpg "monty python")
...
![tabela przestawna ze stałym zakresem](/assets/2017-03-15-dynamiczna-tabela-przestawna/pivot_table_fixed_range.gif "tabela przestawna ze stałym zakresem")
...
![menadżer nazw](/assets/2017-03-15-dynamiczna-tabela-przestawna/new_named_formula.gif "menadżer nazw")

Teraz możemy edytować wstawioną na początku tabelą przestawną i zmienić jest zakres wstawiając nazwę *RNG_FOR_PIVOT_TABLE*.

![tabela przestawna z dynamicznym zakresem](/assets/2017-03-15-dynamiczna-tabela-przestawna/pivot_table_dynamic_range.gif "tabela przestawna z dynamicznym zakresem")
